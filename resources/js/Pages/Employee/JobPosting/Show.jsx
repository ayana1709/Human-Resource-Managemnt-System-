        ...
        <div className="max-w-4xl mx-auto p-6 bg-gray-100 min-h-screen">
            ...
            <div className="bg-white p-6 rounded-lg shadow-md">
                ...
                <div className="mt-6">
                    <button
                        onClick={() =>
                            Inertia.visit(route("job-postings.index"))
                        }
                        className="mr-2 bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 transition duration-200"
                    >
                        Back to List
                    </button>
                    <button
                        onClick={() =>
                            Inertia.visit(
                                route("job-postings.apply", posting.id)
                            )
                        }
